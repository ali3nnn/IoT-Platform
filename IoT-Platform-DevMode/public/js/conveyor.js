...
//     showNotification('New link: <a href="https://anysensor.dasstec.ro/">ANYSENSOR.DASSTEC.RO</a>', 'top')
// })

// timeoutAsync(1500, function(){
//     showNotification('Bold notification', 'top')
// })
// =================================
// End Bold Notification
...
function checkGate() {
    sendMessage(client, 'gate/' + username, 'status')
}

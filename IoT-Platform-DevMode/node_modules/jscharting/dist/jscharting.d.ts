...
export declare interface JSCSpRangeConfig_object {
    ...
    /**
     * Interval of the ranges generaed.
     */
    interval?: number;
    [any: string]: any;
}
...
export declare interface JSCPointMarkerConfig {
     ...
     */
    type?: string | string | JSCIconConfig;
...
* @param variations - A set of 0-1 values defining the range of variation of each HSL component in the resulting color palettte.
...
* @returns Numeric result of the calcualtion.
* @since 2.7
...
export declare class Axis {
    ...
    /**
    * A runique ID provided by user of generated randomly.
    * @since 2.0
    */
    id: string;
...
export declare interface ChartEvents {
     ...
     * @remarks In the function, the "this" keyword refers to the chart object. An event argument is passed to the specified function. The e.options property contains info about the series that was added to the chart. Returning flase prevents the series from being added.
     * @inline true
     */
...
export declare interface DefaultBreak {
     ...
     * @remarks The 'zigzap' and 'gap' types clip the chartArea at the scale break positions. The 'line' type simply draws a line on top of the scale break position. The 'line' type can be used to create seamless scale breaks by setting the line width to 0. This is the same as using the 'hidden' break type.
     */
...
/**
* Scale breaks as an array of break ranges, or automatic settigns.
* @since 1.1
*/
...
export declare interface Points_object {
    ...
    /**
     * By default a comma delimiter is used, but alternative column delimeters can be specified when using with csv data.
     * @since 2.0
     */
    delimiter?: string;
...
/**
* A set of 0-1 values defining the range of variation of each HSL component in the resulting color palettte.
*/

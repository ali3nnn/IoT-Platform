...
app.get("/map", cookieChecker, authDashboard, getCounties, getSensorLocation, (req, res) => {
    sess = req.session;
...
app.get('/map/:county', cookieChecker, authDashboard, getCounties, getSensorLocation, (req, res) => {

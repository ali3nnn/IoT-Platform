...
const mqttOverSocketIoBridge = (req, res, next) => {
    ...
    //             console.log(`Connected to MQTT Broker as ab on behalf of ` + sess.username);
    //         });
    ...
    //             // Send Dummy Live Scanner
    //             var sendLiveScannerDummy = true
    //             if (sendLiveScannerDummy) {
    //                 socketClient.emit("socketChannel", {
    //                     topic: sess.username + "/scanner",
    //                     message: {
    //                         barcode: Date.now()
    //                     }
    //                 })
    //                 sendLiveScannerDummy = false
    //             } else {
    //                 sendLiveScannerDummy = true
    //             }
